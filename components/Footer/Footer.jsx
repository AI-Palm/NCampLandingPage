...
const Footer = () => {
  return (
    <div className="relative ">
            ...
            <h1 className="absolute w-1/2 top-1/2 left-1/2 pt-1 transform -translate-x-1/2 -translate-y-1/5 z-10 text-white text-center font-appleR00 font-[400px] text-xss sm:text-xs sm:mt-2  md:text-xs md:mt-2 lg:text-lg xl:text-xl xl:mt-5 ">
