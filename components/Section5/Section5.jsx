    ...
    <>  
        ...
        <div className="bg-white/[.18] font-normal   flex flex-col justify-center   " >
            ...
            <div className='flex flex-col  justify-center items-center  '>
                <h1 className="text-xl lg:text-4xl md:text-4xl text-white font-appleB00  text-center   mt-[96px] mb-4 ">
                        ...
                        <div className='flex flex-col md:flex-row justify-between'>
                            <div className="w-[353px]  h-auto bg-white/[.1]  border-white/[.1] rounded-3xl p-4 m-4 text-white flex flex-col  md:w-[353px]  md:h-[229px] "  >
                                ...
                                <div className='flex flex-col md:flex-row  md:items-start items-center'>
                                    ...
                                    <ul className="md:ml-8 mt-5 md:mt-0 list-disc text-textsmall135 text-white font-appleR00">
                            ...
                            <div className=" w-auto h-auto bg-white/[.1]  border-white/[.1] rounded-3xl p-4 m-4 text-white flex flex-col sm:w-auto md:w-[353px] md:h-[229px]  "  >
                                ...
                                <div className='flex flex-col md:flex-row justify-center items-center md:items-start '>
                                    ...
                                    <ul className="md:ml-7 mt-5 md:mt-0 list-disc text-textsmall13 text-white font-appleR00">
                        ...
                        <div className='flex flex-col md:flex-row justify-between'>                      
                            <div className=" w-auto h-auto bg-white/[.1]  border-white/[.1] border-white rounded-3xl p-4 m-4 text-white flex flex-col sm:w-auto md:w-[353px] md:h-[229px]  "  >
                                ...
                                <div className='flex flex-col md:flex-row justify-center md:items-start items-center  '>
                                    <Image src={SpringIcon} className="bg-white rounded-xl ml-2 w-[103px] h-[103px] p-6 sm:p-4 " alt="DeviconJava Logo" />
                                    <ul className="md:ml-8 mt-5 md:mt-0 list-disc text-textsmall135 text-white font-appleR00">
                                        <li>IoC 컨테이너 사용법</li>
                            ...
                            <div className=" w-auto h-auto bg-white/[.1]  border-white/[.1] border-white rounded-3xl p-4 m-4 text-white flex flex-col sm:w-auto md:w-[353px] md:h-[229px]  "  >
                                ...
                                <div className='flex flex-col md:flex-row  items-center md:items-start '>
                                    ...
                                    <ul className="md:ml-7 mt-5 md:mt-0 list-disc text-textsmall135 text-white font-appleR00">
                                        <li>스프링 시큐리티 전체구조</li>
                                        <li>인증 및 권한 다루기 </li>
                                        <li>JWT 토큰 다루기</li>
                        ...
                        <div className='flex flex-col md:flex-row justify-between items-center'>
                            <div className="w-[353px]  h-auto bg-white/[.1]  border-white/[.1] rounded-3xl p-4 m-4 text-white flex flex-col  md:w-[353px]  md:h-[239px] "  >
                                ...
                                <div className='flex flex-col md:flex-row  items-center md:items-start '>
                                    ...
                                    <ul className="md:ml-6 mt-5 md:mt-0 list-disc text-sm text-white font-appleR00 ">
                                        <li>JDK 설치 및 설정</li>
                            ...
                            <div className="w-[353px]  h-auto bg-white/[.1]  border-white/[.1] rounded-3xl p-4 m-4 text-white flex flex-col  md:w-[353px]  md:h-[239px] "  >
                                ...
                                <div className='flex flex-col md:flex-row justify-center items-center md:items-start  '>
                                    ...
                                    <ul className="md:ml-6 mt-5 md:mt-0 list-disc text-textsmall12 text-white font-appleR00">
                                        <li>자바스크립트 기본 문법</li>
                        ...
                        <div className='flex flex-col md:flex-row justify-between items-center'>
                            ...
                            <div className="w-[353px]  h-auto bg-white/[.1]  border-white/[.1] rounded-3xl p-4 m-4 text-white flex flex-col  md:w-[353px]  md:h-[239px] "  >
                                ...
                                <div className='flex flex-col md:flex-row  items-center md:items-start  '>
                                    ...
                                    <ul className="md:ml-6 mt-5 md:mt-0 list-disc text-textsmall13 text-white font-appleR00">
                        ...
                        <div className='flex flex-col md:flex-row justify-center items-center mb-[101px]'>                      
                            <div className="w-[353px]  h-auto bg-white/[.1]  border-white/[.1] rounded-3xl p-4 m-4 text-white flex flex-col  md:w-[353px]  md:h-[239px] "  >
                                ...
                                <div className='flex flex-col md:flex-row justify-center md:items-start items-center'>
                                    ...
                                    <ul className="md:ml-6 mt-5 md:mt-0 list-disc text-textsmall12space1dot2 text-white font-appleR00">
                                        <li>운영 서버 아키텍처 설계    </li>
