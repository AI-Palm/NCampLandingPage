...
export default function Section10() {
    return (
        <div className="main mt-[330px]">
            <motion.div
                className="font-rokaf text-white text-center text-[50px] font-bold leading-normal"
                    ...
                    <div className="w-[88%] h-[81%] absolute top-[7%] flex flex-col divide-y divide-white">
                        <div className="grow sm:py-[50px] py-5 overflow-hidden">
                            <ItemReview
                                ...
                                accName={"김OO(자바205기)"}
                                comment={`“커리큘럼이 조금 빡빡하긴 하지만 <span style="color: #fff;">좋은 강사님</span>을 만나서 진행하는데에 많은 도움이 되었습니다. <span style="color: #fff;">직접 실습을 통해 프로그래밍을 배우는 커리큘럼</span>이 좋았습니다. <span style="color: #fff;">과제를 통해 참여도를 끌어올렸던 것</span>이 많은 도움이 된 것 같아요 6개월이 길다고 생각했는데 진짜 금방지나갔고, 좋은 강사님과 함께 잘 수료했습니다.”`} />
                            <ItemReview
                                index={1}
                                avatar={"/section10/pic2-avatar.png"}
                                accName={"최OO(자바180기)"}
                                comment={`코딩에 대한 기초 지식조차 없었는데 이 과정을 수료하기까지 정말 많은 부분을 배울 수 있었고 학원도 만족스러웠습니다. 전문성있는 강사님의 가르침 아래, 팀원들끼리 서로 격려하면서 좋은 분위기 속에서 공부할 수 있었습니다. 비전공자라 생소한 용어들이 많이 나와 처음엔 수업 따라가기 쉽지 않았지만, <span style="color: #000;">실습과 프로젝트를 통해 직접 코딩해보면서 많이 배울 수 있었습니다.</span>`} />
                            <ItemReview
                                index={2}
                                avatar={"/section10/pic3-avatar.png"}
                                accName={"박OO(자바205기)"}
                                comment={`김영진 강사님께서 잘 이끌어주셔서 많이 배웠습니다. 비전공자라 수업내용을 따라가는데 어려움이 없진 않았지만, 궁금한 부분을 세심하게 봐주셔서 실력향상에 많은 도움이 되었습니다. <span style="color: #fff;">정규 수업시간 외에 실습이 많아서 좋았고</span>, 마지막 프로젝트 하면서 확실히 실력이 확 늘었습니다.`} />
                            <ItemReview
                                index={3}
                                avatar={"/section10/pic4-avatar.png"}
                                accName={"장OO(자바180기)"}
